...
protected:
	...
	string abs_nec;
public:
	echipament(string nume, int cant, int tip, string an, int greu) : tabara(nume, cantitate, tip)
	{
		this->greutate = greu;
		this->abs_nec = an;
	}
...
public:
	medicament(string nume, int cant, int tip, string contr, string desc) :tabara(nume, cantitate, tip)
	{
...
void adaugare(list<tabara*>& lista, int tip)
{
	...
	tabara* tab = new tabara(nume, cantitate, tip);
	lista.push_front(tab);
}
